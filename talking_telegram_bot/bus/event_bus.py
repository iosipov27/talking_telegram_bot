...
class InMemoryEventBus:
    def __init__(
        ...
        self._worker_count = max(2, worker_count)
        self._queue: asyncio.Queue[_PendingEvent | object] = asyncio.Queue()
        self._workers: list[asyncio.Task[None]] = []
        self._startup_lock = asyncio.Lock()
        self._started = False

    def subscribe(self, message_type: type[Any], subscriber: Any) -> None:
        self._registry.register_event_subscriber(message_type, subscriber)
