...
from talking_telegram_bot.constants.user_messages import FILE_READ_ERROR_MESSAGE, SAFE_LLM_ERROR_MESSAGE
...
class TelegramDocumentController:
    ...
    async def handle_document_message(
        ...
        try:
            ...
            logger.exception(log_events.DOCUMENT_MESSAGE_PROCESSING_FAILED, "download")
            await self._send_direct_reply(message, FILE_READ_ERROR_MESSAGE)
            return
